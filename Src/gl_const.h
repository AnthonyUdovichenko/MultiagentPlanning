...
//Search Parameters
    ...
    #define CN_SP_PR 4 //Priority

        #define CNS_SP_PR_RAND      "random"
        #define CNS_SP_PR_SHORT     "shortest-first"
        #define CNS_SP_PR_LONG      "longest-first"
        #define CNS_SP_PR_CUSTOM    "custom"

        #define CN_SP_PR_RAND   0
        #define CN_SP_PR_SHORT  1
        #define CN_SP_PR_LONG   2
        #define CN_SP_PR_CUSTOM 3
